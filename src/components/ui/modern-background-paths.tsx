...
export default function EnhancedBackgroundPaths() {
    ...
    // Custom texts for the project
    const title = "Projenizi hayata geçirelim"
    const description = "Dijital hedeflerinizi birlikte belirleyelim ve markanızı büyütecek stratejiler geliştirelim."
    const buttonText = "Hemen Başlayalım"
    ...
    return (
        <div className="relative py-32 w-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    {/* Main Title */}
                    <div className="mb-8">
                        <h2 className="text-4xl sm:text-5xl md:text-7xl font-black mb-4 tracking-tighter leading-none">
                                ...
                                <span key={wordIndex} className="inline-block mr-4 md:mr-6 last:mr-0">
                                    {word.split("").map((letter, letterIndex) => (
                                        <motion.span
                                          ...
                                          hover:from-blue-600 hover:to-purple-600 dark:hover:from-emerald-400 dark:hover:to-teal-400
                    ...
                    >
                        <div className="relative p-[2px] bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 rounded-2xl group-hover:from-emerald-600 group-hover:via-teal-600 group-hover:to-cyan-600 transition-all duration-300">
                            <Button
                                variant="ghost"
                                size="lg"
                    ...
                    >
                        Design Algorithm: <span className="text-slate-700 dark:text-slate-200 font-semibold capitalize">{patterns[currentPattern]}</span>
                    </motion.div>
                </motion.div>
            </div>
            ...
            {/* Floating Elements */}
            <motion.div
                className="absolute top-1/4 left-1/4 w-4 h-4 bg-emerald-500/20 rounded-full blur-sm"
                animate={{
                    y: [0, -20, 0],
                    x: [0, 10, 0],
                    scale: [1, 1.2, 1],
            ...
            />
            <motion.div
                className="absolute top-3/4 right-1/3 w-6 h-6 bg-teal-500/20 rounded-full blur-sm"
                animate={{
                    y: [0, 15, 0],
                    x: [0, -15, 0],
                    scale: [1, 0.8, 1],
